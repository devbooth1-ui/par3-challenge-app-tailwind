...
export default function Home() {
  ...
  const handleTap = () => {
    // Your original flow: go to Play Game from the home hero
    navigate("/play");
  };
    ...
    <div className="relative min-h-screen flex flex-col justify-start items-center overflow-hidden text-white">
      ...
      <div className="relative w-full flex flex-col items-center mt-0 mb-0 z-20">
        <div className="flex flex-col items-center mb-1">
          ...
          />
          <h1
            className="font-extrabold drop-shadow mb-0 text-2xl xs:text-3xl sm:text-4xl flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-center leading-tight mt-0"
          ...
          <h3 className="text-sm sm:text-lg font-bold text-lime-200 mb-0 text-center max-w-xs sm:max-w-xl px-0 drop-shadow-lg flex flex-nowrap items-end justify-center gap-x-0">
            ...
            <span className="text-sm sm:text-base font-semibold text-lime-200 ml-1 mr-1 whitespace-nowrap">
              Today
            </span>
            <span className="text-xl sm:text-2xl font-extrabold text-white drop-shadow-lg">
              $1 Million
            </span>
            <span className="text-sm sm:text-base font-semibold text-lime-200 ml-1 whitespace-nowrap">
              Tomorrow
            </span>
          </h3>
          <h4
        ...
        <div className="w-full flex justify-center items-center mt-6 mb-2 px-2">
          <div
            className="relative bg-emerald-600/30 rounded-xl p-3 sm:p-5 shadow-lg backdrop-blur-sm border border-emerald-300/40 min-w-[180px] max-w-xs sm:max-w-md w-full flex flex-col items-start"
          ...
          >
            ...
            <ul className="text-white/80 text-sm sm:text-base font-medium list-disc pl-4 space-y-2">
              ...
              <li>
                <span className="font-bold text-yellow-300">Hole in One</span>{" "}
                wins <span className="font-bold">$1000</span> +{" "}
                <span className="font-bold">
                  Instant qualify for $1M shootout
                </span>
              </li>
            </ul>
          </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-20 bg-emerald-900/90 backdrop-blur-md border-t border-emerald-400/30 p-1 sm:p-2">
        <div className="max-w-lg mx-auto flex flex-col items-center">
          <div className="flex items-center justify-center gap-2 mb-0">
            ...
            <span className="text-lime-200 font-semibold text-xs">
              Shot Verification Active
            </span>
          </div>
