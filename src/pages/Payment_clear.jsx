        ...
        >
            <div className="max-w-lg w-full space-y-6">
                <div className="text-center mb-8">
                    ...
                    {/* Cost Display */}
                    <div className="bg-white/20 border border-white/30 rounded-xl p-4 mb-4 max-w-sm mx-auto">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                    <button className="flex flex-col items-center p-4 border-2 border-white border-opacity-40 rounded-lg hover:border-yellow-400 transition-all text-white bg-white/10">
                ...
                <div className="grid grid-cols-1 gap-4 mb-6">
                    <button
                        ...
                        className={`p-4 border-2 border-white border-opacity-40 rounded-lg transition-all text-white bg-white/10 hover:border-yellow-400 ${paymentMethod === "card" ? "border-yellow-400 bg-yellow-400/20" : ""}`}
                    >
                    ...
                    <button
                        ...
                        className={`p-4 border-2 border-white border-opacity-40 rounded-lg transition-all text-white bg-white/10 hover:border-yellow-400 ${paymentMethod === "apple-pay" ? "border-yellow-400 bg-yellow-400/20" : ""}`}
                    >
                        <div className="flex items-center">
                            <div className="text-2xl mr-4">🍎</div>
                    ...
                    <button
                        ...
                        className={`p-4 border-2 border-white border-opacity-40 rounded-lg transition-all text-white bg-white/10 hover:border-yellow-400 ${paymentMethod === "google-pay" ? "border-yellow-400 bg-yellow-400/20" : ""}`}
                    >
                        <div className="flex items-center">
                            <div className="text-2xl mr-4">🎯</div>
